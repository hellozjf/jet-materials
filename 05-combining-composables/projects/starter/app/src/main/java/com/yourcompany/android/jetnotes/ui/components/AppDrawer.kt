...
private fun ScreenNavigationButton(
    ...
    // 为按钮的两种不同状态定义图像的 alpha 值：selected / unselected
    ...
    // 为按钮的两种不同状态定义文本的颜色：selected / unselected
    ...
    // 为按钮的两种不同状态定义背景的颜色：selected / unselected
...
@Preview
@Composable
fun ScreenNavigationButtonPreview2() {
    JetNotesTheme {
        ScreenNavigationButton(
